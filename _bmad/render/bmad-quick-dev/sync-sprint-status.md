...
- `story_key` is unset
- `/home/delorenj/code/srvls/{output_folder}/implementation-artifacts/sprint-status.yaml` does not exist on disk

## Instructions

1. Load the FULL `/home/delorenj/code/srvls/{output_folder}/implementation-artifacts/sprint-status.yaml` file.
