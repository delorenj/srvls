...
# srvls - Epic Breakdown

## Overview

This document provides the complete epic and story breakdown for srvls, decomposing the user-confirmed Rust/ratatui brief, preserved brownfield behavior, and finalized architecture into implementable stories.
