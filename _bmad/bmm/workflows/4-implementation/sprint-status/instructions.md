...
<action>For each correction use only `python3 tests/transition_story_status.py &lt;story_id&gt; &lt;story_key&gt; &lt;current&gt; &lt;target&gt; &lt;sprint-status-path&gt;`; HALT the batch on non-zero and never write a Story status directly</action>
